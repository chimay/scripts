echo "KEYMAP=be" >> /etc/rc.conf # sudo
echo "echo bye" >> /etc/rc.conf.shutdown # sudo
echo "echo hello" >> /etc/rc.conf.local # sudo
ln -s /etc/sv/sshd /etc/runit/runsvdir/default # sudo
ln -s /etc/sv/sshd /var/service # sudo
...
sv up sshd # sudo
void-installer # sudo
xbps-install -S octoxbps # sudo
xbps-install -S void-repo-multilib # sudo
xbps-install -S void-repo-multilib-nonfree # sudo
xbps-install -S void-repo-nonfree # sudo
xbps-install -S xtools # sudo
xbps-install -Su # sudo
